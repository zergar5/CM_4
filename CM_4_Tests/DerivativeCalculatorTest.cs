...
public class DerivativeCalculatorTest
{
    ...
    {
        var expected = DerivativeCalculator.CalcDerivative(_line, 'x', _point);
    ...
    {
        var expected = DerivativeCalculator.CalcDerivative(_line, 'y', _point);
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    {
        var expected = DerivativeCalculator.CalcDerivative(_circle, 'x', _point);
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    {
        var expected = DerivativeCalculator.CalcDerivative(_circle, 'y', _point);
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    {
        var expected = DerivativeCalculator.CalcDerivative(_sinusoid, 'x', _point);
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    {
        var expected = DerivativeCalculator.CalcDerivative(_sinusoid, 'y', _point);
        Assert.That(actual, Is.EqualTo(expected));
    }
}